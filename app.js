...
questionBank = [
  ...
  ...(Array.isArray(window.PARAGRAPH7_EXPANDED_QUESTIONS) ? window.PARAGRAPH7_EXPANDED_QUESTIONS : []),
  ...(Array.isArray(window.PARAGRAPH7_SCANNED_QUESTIONS) ? window.PARAGRAPH7_SCANNED_QUESTIONS : []),
  ...
  ...(Array.isArray(window.PARAGRAPH8_BATCH_QUESTIONS) ? window.PARAGRAPH8_BATCH_QUESTIONS : []),
  ...(Array.isArray(window.PARAGRAPH8_EXPANDED_QUESTIONS) ? window.PARAGRAPH8_EXPANDED_QUESTIONS : []),
